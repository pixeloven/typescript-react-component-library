...
class WebpackDevServerConfig {
     ...
     * @param srcPath
     */
    constructor(server: Server, publicPath: string, srcPath: string) {
        this.server = server;
     ...
     * @param allowedHost
     */
    public create(proxy: Proxy, allowedHost: string): object {
        return {
            ...
            hot: true,
            https: this.server.protocol === "https",
            overlay: false,
            ...
            watchOptions: {
                ignored: ignoredFiles(this.srcPath),
            },
        };
    }
}
